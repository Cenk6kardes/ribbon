...
describe('PreferencesComponent', () => {
  ...
  const statusLogService = jasmine.createSpyObj('statusLogService', ['pushLogs']);
  ...
  it('should call ngAfterViewInit', () => {
    spyOn(component, 'handleLogsOnAutoTermiation');
    ...
    expect(component.handleLogsOnAutoTermiation).toHaveBeenCalled();
  });
  ...
  it('should call handleLogsOnSave', () => {
    component.handleLogsOnAutoTermiation();
    expect(statusLogService.pushLogs).toHaveBeenCalled();
  });
});
