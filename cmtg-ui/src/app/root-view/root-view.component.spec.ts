...
describe('RootViewComponent', () => {
  ...
  const translate = {
    translateResults: {
      SIDEBAR: {
        GATEWAY_CONTROLLERS_LABEL: 'Gateway Controllers',
        NETWORK_CONFIGURATION_LABEL: 'Network Configuration'
      },
      TOP_HEADER: {
        TOP_HEADER_TITLE: ''
      },
  ...
  beforeEach(async () => {
    ...
    authService.autoLogoutSubject$ = new BehaviorSubject<boolean>(true);
