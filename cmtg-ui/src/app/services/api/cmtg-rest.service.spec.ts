...
describe('CmtgRestService', () => {
  let service: CmtgRestService;
  ...
  it('should call putDataParamBody', () => {
    ...
    service
      .putDataParamBody(apiUrl, requestParams, requestData)
      .subscribe((data) => {
        expect(data).toEqual(responseData);
      });
