...
describe('LoginService', () => {
  ...
  const authService = jasmine.createSpyObj('authService', ['login','getPermissionInfo']);
  const storageService = {};
  const permissionResponse={
    principals:[{name:'Princ'}],
    readOnly: true,
    publicCredentials:[],
    privateCredentials:[]
  };
  ...
  beforeEach(() => {
    ...
    authService.getPermissionInfo.and.returnValue(of(permissionResponse));
